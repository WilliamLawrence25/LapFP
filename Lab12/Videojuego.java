      ...
      switch (opcion) {
        case "1":
          do{
            ...
            HashMap<Integer, Soldado> soldados1=crearEjercito(random, tablero, n1);
            HashMap<Integer, Soldado> soldados2=crearEjercito(random, tablero, n2);
        ...
        case "2":
          do{
            ...
            if(gestionar==1)
            modoPersonalizado(n1, sc, random, soldados1, tablero);
            else if(gestionar==2)
            modoPersonalizado(n2, sc, random, soldados2, tablero);
