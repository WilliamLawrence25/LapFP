...
public class Videojuego7 {
  public static void main(String[] args){
    ...
    do{
      ...
      while(soldados1.size()!=0&&soldados2.size()!=0){
        System.out.print("Jugador 1, seleccione soldado: ");
        String s1=sc.next();
        ...
        if(soldados2.size()>0 && soldados1.size()>0){
          System.out.print("Jugador 2, seleccione soldado: ");
          String s2=sc.next();
  ...
  /*public static Soldado[][] actualizarTablero(Soldado s, Soldado[][] tablero){
    ...
    if(control==1){
      ...
      if(fila0>=0 && fila0<fila && columna0>=0 && columna0<columna){
        if(tablero[fila0][columna0]!=null && !soldados.containsValue(tablero[fila0][columna0])){
          ...
          //System.out.println("Soldados en ejercito 1: "+soldados.size());
          //System.out.println("Soldados en ejercito 2: "+soldadosE.size());
